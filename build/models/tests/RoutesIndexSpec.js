...
describe('Test endpoints Routers responses', function () {
    it('gets the api (localhost:3000/products-index) endpoint', function () { return __awaiter(void 0, void 0, void 0, function () {
        var response;
    ...
    it('gets the api (localhost:3000/add-product) endpoint', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, request.post('/add-product')];
                case 1:
                    response = _a.sent();
    ...
    it('gets the api (localhost:3000/product?id=1) endpoint', function () { return __awaiter(void 0, void 0, void 0, function () {
        var response;
        return __generator(this, function (_a) {
            switch (_a.label) {
    ...
    it('gets the api (localhost:3000/user-index) endpoint', function () { return __awaiter(void 0, void 0, void 0, function () {
        var response;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, request.get('/user-index')];
                case 1:
                    response = _a.sent();
                    expect(response.status).toBe(401);
                    return [2 /*return*/];
    ...
    it('gets the api (localhost:3000/signin) endpoint', function () { return __awaiter(void 0, void 0, void 0, function () {
        var response;
        return __generator(this, function (_a) {
            switch (_a.label) {
